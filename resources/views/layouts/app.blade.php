                ...
                <div class="px-4 space-y-2">
                    ...
                    <div class="relative" id="logs-menu">
                        <button id="logs-menu-btn"
                                class="w-full flex items-center justify-between px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('fiscal-receipt-logs.*') || request()->routeIs('anomalies.*') || request()->routeIs('admin.monitoring.*') ? 'bg-sky-600 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <div class="flex items-center">
                                <i class="fas fa-list-alt sidebar-icon mr-3"></i>
                                <span class="sidebar-text">Loguri</span>
                            </div>
                            <i id="logs-menu-arrow" class="fas fa-chevron-down text-xs transition-transform {{ request()->routeIs('fiscal-receipt-logs.*') || request()->routeIs('anomalies.*') || request()->routeIs('admin.monitoring.*') ? 'rotate-180' : '' }}"></i>
                        </button>
                        <div id="logs-submenu" class="ml-4 mt-2 space-y-1 {{ request()->routeIs('fiscal-receipt-logs.*') || request()->routeIs('anomalies.*') || request()->routeIs('admin.monitoring.*') ? '' : 'hidden' }}">
                            ...
                            <a href="{{ route('admin.monitoring.index') }}"
                               class="flex items-center px-4 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('admin.monitoring.*') ? 'bg-sky-500 text-white' : 'text-gray-400 hover:bg-gray-700 hover:text-white' }}">
