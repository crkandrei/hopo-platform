            ...
            <div class="space-y-4 max-w-xl">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $birthdayPackage->price) }}" step="0.01" min="0" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input type="number" name="max_children" id="max_children" value="{{ old('max_children', $birthdayPackage->max_children) }}" min="1" class="w-full max-w-xs px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
