...
@section('title', 'Adaugă Locație')
@section('page-title', 'Adaugă Locație')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 card-hover">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Adaugă Locație Nouă 📍</h1>
                <p class="text-gray-600 text-lg">Creați o nouă locație în sistem</p>
            </div>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox"
                               name="fiscal_enabled"
                               value="1"
                               {{ old('fiscal_enabled', true) ? 'checked' : '' }}
                               class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
