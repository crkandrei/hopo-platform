...
@section('title', 'Prețuri HOPO – Pachete START, STANDARD, PRO pentru locuri de joacă')
@section('meta_description', 'Alege pachetul HOPO potrivit locului tău de joacă: START, STANDARD sau PRO. Demo gratuit și prima lună gratuită. Contactează-ne pentru o ofertă personalizată.')
@section('canonical', 'https://hopo.ro/preturi')

@section('content')
    <section id="pricing" class="pt-28 pb-20 px-6">
        <div class="max-w-6xl mx-auto">
            <div class="text-center mb-12" data-animate>
                <h1 class="text-3xl font-bold mb-4">Avem diferite pachete în funcție de nevoie</h1>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-8">
                ...
                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg hover:border-hopo-purple/50 transition-all flex flex-col" data-animate>
                    <div class="text-center flex flex-col flex-1">
                        <h2 class="text-xl font-semibold mb-6">START</h2>
                        ...
                        <a href="/contact" class="block w-full bg-gray-700 hover:bg-gray-800 text-white py-3 rounded-lg font-medium transition-colors mt-6">
                ...
                <div class="bg-white border-2 border-hopo-purple rounded-2xl p-8 shadow-lg relative flex flex-col" data-animate data-delay="150">
                    ...
                    <div class="text-center flex flex-col flex-1">
                        <h2 class="text-xl font-semibold mb-6">STANDARD</h2>
                        <ul class="text-left space-y-3 flex-1">
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                        ...
                        <a href="/contact" class="block w-full bg-hopo-purple hover:bg-hopo-purple-dark text-white py-3 rounded-lg font-medium transition-colors mt-6">
                            Solicită demo gratuit
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-lg hover:border-hopo-coral/50 transition-all flex flex-col" data-animate data-delay="300">
                    <div class="text-center flex flex-col flex-1">
                        <h2 class="text-xl font-semibold mb-6">PRO</h2>
                        <ul class="text-left space-y-3 flex-1">
                            <li class="flex items-start">
                                <svg class="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
            ...
            <p class="text-center text-gray-500 text-sm mt-8">
                Demo gratuit disponibil. Prima lună gratuită. Contactează-ne pentru detalii.
            </p>
        </div>
    </section>
@endsection
