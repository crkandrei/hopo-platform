...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Editează cotă TVA</h1>
        <p class="mt-1 text-sm text-gray-500">Modifică datele cotei TVA</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.tva-rates.update', $tvaRate) }}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $tvaRate->name) }}" required
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="percentage" value="{{ old('percentage', $tvaRate->percentage) }}" required min="0" max="100" step="0.01"
                    ...
                    <div>
                        ...
                        <input type="number" name="vat_class" value="{{ old('vat_class', $tvaRate->vat_class) }}" required min="1" max="9"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="checkbox" name="is_active" id="is_active" value="1"
                        ...
                        {{ old('is_active', $tvaRate->is_active) ? 'checked' : '' }}>
