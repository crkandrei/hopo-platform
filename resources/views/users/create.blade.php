...
@section('title', 'Adaugă Utilizator')
@section('page-title', 'Adaugă Utilizator')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 card-hover">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Adaugă Utilizator Nou 👤</h1>
                <p class="text-gray-600 text-lg">Creați un nou utilizator în sistem</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select name="status" 
                            ...
                            required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="active" {{ old('status', 'active') == 'active' ? 'selected' : '' }}>Activ</option>
