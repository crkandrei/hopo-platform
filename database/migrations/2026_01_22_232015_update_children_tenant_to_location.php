...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        foreach ($mappings as $mapping) {
            DB::statement("UPDATE children SET location_id = {$mapping->location_id} WHERE tenant_id = {$mapping->tenant_id}");
        }
    ...
    public function down(): void
    {
        ...
        foreach ($mappings as $mapping) {
            DB::statement("UPDATE children SET tenant_id = {$mapping->tenant_id} WHERE location_id = {$mapping->location_id}");
        }
