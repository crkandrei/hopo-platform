...
return [
    ...
    // Necesar pentru performance monitoring (slow queries, slow requests)
    ...
    'tracing' => [
        ...
        // Set la 1000ms - captează stack trace-ul pentru query-urile lente
        'sql_origin_threshold_ms' => env('SENTRY_TRACE_SQL_ORIGIN_THRESHOLD_MS', 1000),
